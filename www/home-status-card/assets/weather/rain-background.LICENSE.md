...
- Title: Rain background animation
- Creator: Joy Ng
- Source: https://lottiefiles.com/free-animation/rain-background-animation-HXadNybVdf
- Local asset: `rain-background.json`
...
This license does not include the right to collect or compile Files from LottieFiles to replicate or develop a similar or competing service.
